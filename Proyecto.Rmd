...
Para analizar la anotación de las secuencias alineadas, se compararon dichas secuencias con respecto a la anotación del genoma de *Heligmosomoides bakeri*
```{r echo=F}
